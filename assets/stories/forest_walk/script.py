# The Forest Walk — a gentle intro story for Bodn Story Mode
#
# 5-node branching story, ~1 minute per playthrough.
# Originally the built-in flash story; now lives on SD alongside other stories.
