...
domain that \citet{duncan2007school} identified as the single strongest
predictor of later academic achievement. Tone Lab adds a third
primary-level auditory-processing mode alongside Soundboard and Story Mode,
and---uniquely---targets cross-modal sound--shape perception
\citep{kohler1929gestalt, maurer2006shape, dolscheid2014thickness} that no
previous mode addressed directly. Remaining areas with limited coverage
include:
