...
graph LR
    ...
    NofirmwarerebuildneededjustchangeandsyncPythonfiles["No firmware rebuild needed — just change and sync Python files.<br/><sub>GPIO 12 → SCK<br/>GPIO 11 → MOSI<br/>GPIO 10 → CS<br/>GPIO 8 → DC<br/>GPIO 9 → RST<br/>GPIO 1 → BL</sub>"]
    NofirmwarerebuildneededjustchangeandsyncPythonfiles -.- ESP
...
| 8 | No firmware rebuild needed — just change and sync Python files. | DC |
| 9 | No firmware rebuild needed — just change and sync Python files. | RST |
| 10 | No firmware rebuild needed — just change and sync Python files. | CS |
| 11 | No firmware rebuild needed — just change and sync Python files. | MOSI |
| 12 | No firmware rebuild needed — just change and sync Python files. | SCK |
