...
BUILTIN_STORY = {
    ...
    "nodes": {
        "start": {
            "text": {
                "sv": "Du och din nallebjorn gar pa en stig i skogen. Solen skiner mellan loven.",
                "en": "You and your teddy bear walk along a forest path. The sun shines through the leaves.",
            },
            "mood": "warm",
            "choices": [
                {
                    "label": {"sv": "Folja stigen", "en": "Follow the path"},
                    "next": "clearing",
                },
                {
                    "label": {"sv": "Titta pa blommorna", "en": "Look at the flowers"},
                    "next": "flowers",
                },
            ],
        },
        "clearing": {
            "text": {
                "sv": "Stigen leder till en liten glanta. Dar sitter en ekorre och ater en nott!",
            ...
            "choices": [
                ...
                {
                    "label": {"sv": "Ga vidare", "en": "Keep walking"},
                    "next": "home_end",
                },
            ],
        },
        "flowers": {
            "text": {
                "sv": "Du hittar vackra bla blommor! Nallen tycker de luktar gott.",
                "en": "You find beautiful blue flowers! Teddy thinks they smell lovely.",
            },
            "mood": "happy",
            "choices": [
                {
                    "label": {"sv": "Plucka en blomma", "en": "Pick a flower"},
                    "next": "home_end",
                },
            ],
        },
        "squirrel_end": {
            "text": {
                "sv": "Ekorren vinkar tillbaka med svansen! Sedan hoppar den upp i ett trad. En fin dag i skogen!",
        ...
        "home_end": {
            "text": {
                "sv": "Du och nallen gar hem igen. Det var en fin promenad!",
